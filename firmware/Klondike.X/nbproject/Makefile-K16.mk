...
OBJECTFILES_QUOTED_IF_SPACED=${OBJECTDIR}/_ext/1360907413/usb_device.p1 ${OBJECTDIR}/_ext/1360907413/usb_hal_pic24.p1 ${OBJECTDIR}/_ext/1360907413/usb_function_generic.p1 ${OBJECTDIR}/_ext/1472/usb_descriptors.p1 ${OBJECTDIR}/asic.p1 ${OBJECTDIR}/i2c.p1 ${OBJECTDIR}/klondike.p1 ${OBJECTDIR}/main.p1 ${OBJECTDIR}/fwup.p1
POSSIBLE_DEPFILES=${OBJECTDIR}/_ext/1360907413/usb_device.p1.d ${OBJECTDIR}/_ext/1360907413/usb_hal_pic24.p1.d ${OBJECTDIR}/_ext/1360907413/usb_function_generic.p1.d ${OBJECTDIR}/_ext/1472/usb_descriptors.p1.d ${OBJECTDIR}/asic.p1.d ${OBJECTDIR}/i2c.p1.d ${OBJECTDIR}/klondike.p1.d ${OBJECTDIR}/main.p1.d ${OBJECTDIR}/fwup.p1.d

# Object Files
OBJECTFILES=${OBJECTDIR}/_ext/1360907413/usb_device.p1 ${OBJECTDIR}/_ext/1360907413/usb_hal_pic24.p1 ${OBJECTDIR}/_ext/1360907413/usb_function_generic.p1 ${OBJECTDIR}/_ext/1472/usb_descriptors.p1 ${OBJECTDIR}/asic.p1 ${OBJECTDIR}/i2c.p1 ${OBJECTDIR}/klondike.p1 ${OBJECTDIR}/main.p1 ${OBJECTDIR}/fwup.p1
...
${OBJECTDIR}/fwup.p1: fwup.c  nbproject/Makefile-${CND_CONF}.mk
	@${MKDIR} ${OBJECTDIR} 
	@${RM} ${OBJECTDIR}/fwup.p1.d 
	${MP_CC} --pass1 $(MP_EXTRA_CC_PRE) --chip=$(MP_PROCESSOR_OPTION) -Q -G --asmlist  -D__DEBUG=1 --debugger=pickit3  --double=24 --float=24 --opt=all,+asm,-asmfile,-speed,+space,-debug,9 --addrqual=require --mode=pro -N100 -I".." -I"../Include" --warn=9 --summary=default,-psect,-class,+mem,-hex,-file --output=default,-inhx032 --runtime=default,+clear,+init,-keep,-no_startup,+osccal,-resetbits,-download,-stackcall,+clib "--errformat=%f:%l: error: %s" "--warnformat=%f:%l: warning: %s" "--msgformat=%f:%l: advisory: %s"  -o${OBJECTDIR}/fwup.p1  fwup.c 
	@-${MV} ${OBJECTDIR}/fwup.d ${OBJECTDIR}/fwup.p1.d 
	@${FIXDEPS} ${OBJECTDIR}/fwup.p1.d $(SILENT) -rsi ${MP_CC_DIR}../  
